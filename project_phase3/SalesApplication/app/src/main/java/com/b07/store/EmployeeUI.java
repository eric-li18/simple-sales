...
//      EmployeeInterface employeeInterface, Context context) throws IOException {
//    String userInput = "";
//    int quantity = -1;
//    boolean valid = false;
//
...
//        case "1":
//          userId =
//              StoreAuthentication.authenticationInterface(bufferedReader, Roles.EMPLOYEE.name(), context);
//          if (userId != -1) {
...
//          user = DatabaseSelectHelper.getUserDetails(userId, context);
//          Customer customer =
//              new Customer(user.getId(), user.getName(), user.getAge(), user.getAddress(), context);
//          break;
//
//        case "3":
...
//          if (userId != -1) {
//            /**
//             * active needs to be changed I think
//             */
//            accId = DatabaseInsertHelper.insertAccount(userId, true, context);
//          }
//          if (accId != -1) {
...
//          Item item;
//
//          List<Item> items = DatabaseSelectHelper.getAllItems(context);
//          if (items.isEmpty()) {
...
//                + DatabaseSelectHelper.getInventoryQuantity(i.getId(), context));
//          }
//
//          valid = false;
...
//              System.out.println("Enter a valid quantity.");
//            }
//            item = DatabaseSelectHelper.getItem(itemId, context);
...
//          }
//
//          itemId = DatabaseInsertHelper.insertItem(itemType, price, context);
//          item = DatabaseSelectHelper.getItem(itemId, context);
